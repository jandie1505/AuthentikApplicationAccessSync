...
/**
 * AuthenticatedSessionUserAgentOs Class Doc Comment
 *
 * @category Class
 ...
 */
class AuthenticatedSessionUserAgentOs implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AuthenticatedSession_user_agent_os';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['patch_minor'] === null) {
            $invalidProperties[] = "'patch_minor' can't be null";
        }
