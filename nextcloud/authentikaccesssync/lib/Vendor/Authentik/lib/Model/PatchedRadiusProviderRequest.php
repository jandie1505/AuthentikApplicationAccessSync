...
/**
 * PatchedRadiusProviderRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedRadiusProviderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PatchedRadiusProviderRequest';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedRadiusProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setClientNetworks($client_networks)
    {
        ...
        if ((mb_strlen($client_networks) < 1)) {
            throw new \InvalidArgumentException('invalid length for $client_networks when calling PatchedRadiusProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSharedSecret($shared_secret)
    {
        ...
        if ((mb_strlen($shared_secret) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shared_secret when calling PatchedRadiusProviderRequest., must be bigger than or equal to 1.');
        }
