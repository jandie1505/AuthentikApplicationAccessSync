...
/**
 * TelegramChallengeResponseRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TelegramChallengeResponseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TelegramChallengeResponseRequest';
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TelegramChallengeResponseRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TelegramChallengeResponseRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling TelegramChallengeResponseRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling TelegramChallengeResponseRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 255)) {
            throw new \InvalidArgumentException('invalid length for $username when calling TelegramChallengeResponseRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling TelegramChallengeResponseRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPhotoUrl($photo_url)
    {
        ...
        if ((mb_strlen($photo_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $photo_url when calling TelegramChallengeResponseRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setHash($hash)
    {
        ...
        if ((mb_strlen($hash) > 64)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling TelegramChallengeResponseRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($hash) < 1)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling TelegramChallengeResponseRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setComponent($component)
    {
        ...
        if ((mb_strlen($component) < 1)) {
            throw new \InvalidArgumentException('invalid length for $component when calling TelegramChallengeResponseRequest., must be bigger than or equal to 1.');
        }
