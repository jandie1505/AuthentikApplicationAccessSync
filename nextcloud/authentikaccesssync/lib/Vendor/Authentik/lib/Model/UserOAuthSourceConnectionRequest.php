...
/**
 * UserOAuthSourceConnectionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UserOAuthSourceConnectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UserOAuthSourceConnectionRequest';
    ...
    public function setIdentifier($identifier)
    {
        ...
        if ((mb_strlen($identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling UserOAuthSourceConnectionRequest., must be bigger than or equal to 1.');
        }
