...
class UserConsent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'application' => '\OCA\AuthentikAccessSync\Vendor\Authentik\Model\Application',
        'permissions' => 'string'
    ];
     ...
     * Sets application
     *
     * @param \OCA\AuthentikAccessSync\Vendor\Authentik\Model\Application $application application
     *
     * @return self
     */
