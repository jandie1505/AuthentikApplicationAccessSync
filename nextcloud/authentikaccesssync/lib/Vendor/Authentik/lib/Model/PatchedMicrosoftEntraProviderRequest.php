...
/**
 * PatchedMicrosoftEntraProviderRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedMicrosoftEntraProviderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PatchedMicrosoftEntraProviderRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['tenant_id']) && (mb_strlen($this->container['tenant_id']) < 1)) {
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedMicrosoftEntraProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setClientId($client_id)
    {
        ...
        if ((mb_strlen($client_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $client_id when calling PatchedMicrosoftEntraProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setClientSecret($client_secret)
    {
        ...
        if ((mb_strlen($client_secret) < 1)) {
            throw new \InvalidArgumentException('invalid length for $client_secret when calling PatchedMicrosoftEntraProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling PatchedMicrosoftEntraProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSyncPageSize($sync_page_size)
    {
        ...
        if (($sync_page_size > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $sync_page_size when calling PatchedMicrosoftEntraProviderRequest., must be smaller than or equal to 2147483647.');
        }
        if (($sync_page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $sync_page_size when calling PatchedMicrosoftEntraProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSyncPageTimeout($sync_page_timeout)
    {
        ...
        if ((mb_strlen($sync_page_timeout) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sync_page_timeout when calling PatchedMicrosoftEntraProviderRequest., must be bigger than or equal to 1.');
        }
