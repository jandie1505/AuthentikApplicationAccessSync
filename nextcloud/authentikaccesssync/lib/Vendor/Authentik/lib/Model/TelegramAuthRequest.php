...
/**
 * TelegramAuthRequest Class Doc Comment
 *
 * @category Class
 * @package  OCA\AuthentikAccessSync\Vendor\Authentik
 * @author   OpenAPI Generator team
 ...
 */
class TelegramAuthRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TelegramAuthRequest';
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TelegramAuthRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TelegramAuthRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling TelegramAuthRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling TelegramAuthRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 255)) {
            throw new \InvalidArgumentException('invalid length for $username when calling TelegramAuthRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling TelegramAuthRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPhotoUrl($photo_url)
    {
        ...
        if ((mb_strlen($photo_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $photo_url when calling TelegramAuthRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setHash($hash)
    {
        ...
        if ((mb_strlen($hash) > 64)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling TelegramAuthRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($hash) < 1)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling TelegramAuthRequest., must be bigger than or equal to 1.');
        }
