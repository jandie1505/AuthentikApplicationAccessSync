...
/**
 * LDAPProvider Class Doc Comment
 *
 * @category Class
 ...
 */
class LDAPProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'LDAPProvider';
    ...
    public function setUidStartNumber($uid_start_number)
    {
        ...
        if (($uid_start_number > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $uid_start_number when calling LDAPProvider., must be smaller than or equal to 2147483647.');
        }
        if (($uid_start_number < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $uid_start_number when calling LDAPProvider., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setGidStartNumber($gid_start_number)
    {
        ...
        if (($gid_start_number > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $gid_start_number when calling LDAPProvider., must be smaller than or equal to 2147483647.');
        }
        if (($gid_start_number < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $gid_start_number when calling LDAPProvider., must be bigger than or equal to -2147483648.');
        }
