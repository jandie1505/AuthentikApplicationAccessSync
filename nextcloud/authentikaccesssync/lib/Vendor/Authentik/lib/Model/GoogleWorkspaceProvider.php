...
/**
 * GoogleWorkspaceProvider Class Doc Comment
 *
 * @category Class
 ...
 */
class GoogleWorkspaceProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GoogleWorkspaceProvider';
    ...
    public function setDelegatedSubject($delegated_subject)
    {
        ...
        if ((mb_strlen($delegated_subject) > 254)) {
            throw new \InvalidArgumentException('invalid length for $delegated_subject when calling GoogleWorkspaceProvider., must be smaller than or equal to 254.');
        }
    ...
    public function setSyncPageSize($sync_page_size)
    {
        ...
        if (($sync_page_size > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $sync_page_size when calling GoogleWorkspaceProvider., must be smaller than or equal to 2147483647.');
        }
        if (($sync_page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $sync_page_size when calling GoogleWorkspaceProvider., must be bigger than or equal to 1.');
        }
