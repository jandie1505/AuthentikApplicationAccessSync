...
/**
 * EnrollRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EnrollRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EnrollRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['device_serial'] === null) {
            $invalidProperties[] = "'device_serial' can't be null";
        }
        if ((mb_strlen($this->container['device_serial']) < 1)) {
            $invalidProperties[] = "invalid value for 'device_serial', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setDeviceSerial($device_serial)
    {
        ...
        if ((mb_strlen($device_serial) < 1)) {
            throw new \InvalidArgumentException('invalid length for $device_serial when calling EnrollRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDeviceName($device_name)
    {
        ...
        if ((mb_strlen($device_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $device_name when calling EnrollRequest., must be bigger than or equal to 1.');
        }
