...
/**
 * PatchedEnrollmentTokenRequest Class Doc Comment
 *
 * @category Class
 * @package  OCA\AuthentikAccessSync\Vendor\Authentik
 * @author   OpenAPI Generator team
 ...
 */
class PatchedEnrollmentTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PatchedEnrollmentTokenRequest';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedEnrollmentTokenRequest., must be bigger than or equal to 1.');
        }
