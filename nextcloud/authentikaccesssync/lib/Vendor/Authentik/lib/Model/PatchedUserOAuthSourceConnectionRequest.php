...
/**
 * PatchedUserOAuthSourceConnectionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedUserOAuthSourceConnectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PatchedUserOAuthSourceConnectionRequest';
    ...
    public function setIdentifier($identifier)
    {
        ...
        if ((mb_strlen($identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling PatchedUserOAuthSourceConnectionRequest., must be bigger than or equal to 1.');
        }
