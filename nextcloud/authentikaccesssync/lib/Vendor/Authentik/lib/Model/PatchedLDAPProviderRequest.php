...
/**
 * PatchedLDAPProviderRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedLDAPProviderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PatchedLDAPProviderRequest';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedLDAPProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setBaseDn($base_dn)
    {
        ...
        if ((mb_strlen($base_dn) < 1)) {
            throw new \InvalidArgumentException('invalid length for $base_dn when calling PatchedLDAPProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setUidStartNumber($uid_start_number)
    {
        ...
        if (($uid_start_number > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $uid_start_number when calling PatchedLDAPProviderRequest., must be smaller than or equal to 2147483647.');
        }
        if (($uid_start_number < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $uid_start_number when calling PatchedLDAPProviderRequest., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setGidStartNumber($gid_start_number)
    {
        ...
        if (($gid_start_number > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $gid_start_number when calling PatchedLDAPProviderRequest., must be smaller than or equal to 2147483647.');
        }
        if (($gid_start_number < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $gid_start_number when calling PatchedLDAPProviderRequest., must be bigger than or equal to -2147483648.');
        }
