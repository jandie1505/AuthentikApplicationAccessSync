...
class Review implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'iteration' => 'string',
        'reviewer' => '\OCA\AuthentikAccessSync\Vendor\Authentik\Model\ReviewerUser',
        'timestamp' => '\DateTime',
        'note' => 'string'
    ];
     ...
     * Sets reviewer
     *
     * @param \OCA\AuthentikAccessSync\Vendor\Authentik\Model\ReviewerUser $reviewer reviewer
     *
     * @return self
     */
