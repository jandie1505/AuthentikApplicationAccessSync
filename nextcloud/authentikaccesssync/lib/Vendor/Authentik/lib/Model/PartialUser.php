 ...
 */
class PartialUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PartialUser';
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 150)) {
            throw new \InvalidArgumentException('invalid length for $username when calling PartialUser., must be smaller than or equal to 150.');
        }
        if ((!preg_match("/^[\\w.@+-]+$/", ObjectSerializer::toString($username)))) {
            throw new \InvalidArgumentException("invalid value for \$username when calling PartialUser., must conform to the pattern /^[\\w.@+-]+$/.");
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PartialUser., must be smaller than or equal to 254.');
        }
