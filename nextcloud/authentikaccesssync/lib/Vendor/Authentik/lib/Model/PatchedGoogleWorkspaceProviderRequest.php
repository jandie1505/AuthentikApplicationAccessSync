...
/**
 * PatchedGoogleWorkspaceProviderRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedGoogleWorkspaceProviderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PatchedGoogleWorkspaceProviderRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['delegated_subject']) && (mb_strlen($this->container['delegated_subject']) > 254)) {
            $invalidProperties[] = "invalid value for 'delegated_subject', the character length must be smaller than or equal to 254.";
        }

        if (!is_null($this->container['delegated_subject']) && (mb_strlen($this->container['delegated_subject']) < 1)) {
        ...
        if (!is_null($this->container['default_group_email_domain']) && (mb_strlen($this->container['default_group_email_domain']) < 1)) {
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedGoogleWorkspaceProviderRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $delegated_subject delegated_subject
     *
     * @return self
     */
    public function setDelegatedSubject($delegated_subject)
    {
        ...
        if ((mb_strlen($delegated_subject) > 254)) {
            throw new \InvalidArgumentException('invalid length for $delegated_subject when calling PatchedGoogleWorkspaceProviderRequest., must be smaller than or equal to 254.');
        }
        if ((mb_strlen($delegated_subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $delegated_subject when calling PatchedGoogleWorkspaceProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setScopes($scopes)
    {
        ...
        if ((mb_strlen($scopes) < 1)) {
            throw new \InvalidArgumentException('invalid length for $scopes when calling PatchedGoogleWorkspaceProviderRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $default_group_email_domain default_group_email_domain
     *
     * @return self
     */
    public function setDefaultGroupEmailDomain($default_group_email_domain)
    {
        ...
        if ((mb_strlen($default_group_email_domain) < 1)) {
            throw new \InvalidArgumentException('invalid length for $default_group_email_domain when calling PatchedGoogleWorkspaceProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSyncPageSize($sync_page_size)
    {
        ...
        if (($sync_page_size > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $sync_page_size when calling PatchedGoogleWorkspaceProviderRequest., must be smaller than or equal to 2147483647.');
        }
        if (($sync_page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $sync_page_size when calling PatchedGoogleWorkspaceProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSyncPageTimeout($sync_page_timeout)
    {
        ...
        if ((mb_strlen($sync_page_timeout) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sync_page_timeout when calling PatchedGoogleWorkspaceProviderRequest., must be bigger than or equal to 1.');
        }
